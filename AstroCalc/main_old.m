...
#import "ACHelpers.h"
#import "ACRiseTransitSet.h"
#import "ACMoon.h"
#import "ACCoordinateTransformation.h"
#import "ACNutation.h"
...
//        NSDate *myDate = [NSDate dateWithString:@"1977-02-14 00:00:00 +0000"];
        ...
        CGFloat k = [ACMoonPhases calculateKFromDecimalYear:[mainDate fractionalYear]];
        CGFloat kNewMoon = [AAHelpers toInt:k];
        
        CGFloat julianDayNewMoon = [ACMoonPhases truePhaseFromK:kNewMoon];
        CGFloat julianDayNextNewMoon = [ACMoonPhases truePhaseFromK:kNewMoon + 1];
