...
void PrintSunAndMoonInfo(long year, long month, long day, double longitude, double latitude)
{
...
void GetMercuryRaDecByJulian(double JD, double& RA, double& Dec)
{
  double JDMercury = CAADynamicalTime::UTC2TT(JD);
  double lambda = CAAMercury::EclipticLongitude(JDMercury);
  double beta = CAAMercury::EclipticLatitude(JDMercury);
...
CAARiseTransitSetDetails GetMercuryRiseTransitSet(double JD, double longitude, double latitude)
{
  double alpha1 = 0;
  double delta1 = 0;
  GetMercuryRaDecByJulian(JD - 1, alpha1, delta1);
  double alpha2 = 0;
  double delta2 = 0;
  GetMercuryRaDecByJulian(JD, alpha2, delta2);
  double alpha3 = 0;
  double delta3 = 0;
  GetMercuryRaDecByJulian(JD + 1, alpha3, delta3);
...
void PrintMercuryInfo(double JD, double longitude, double latitude)
{
  CAARiseTransitSetDetails Mercury_rise_transit_set(GetMercuryRiseTransitSet(JD, longitude, latitude));
...
int main()
{
  ...
  for (int i=0; i<static_cast<int>(sizeof(city_names2)/sizeof(char*)); ++i)
  {
    ...
    PrintSunAndMoonInfo2(city_names2[i], Year, Month, Day, time_offset, longitudes_latitudes2[i][0], longitudes_latitudes2[i][1]);
  }
  ...
  */
  ...
  {
    double NorthwardEquinox = CAAEquinoxesAndSolstices::NorthwardEquinox(Year);
    ...
    double NorthernSolstice = CAAEquinoxesAndSolstices::NorthernSolstice(Year);
    ...
    double SouthwardEquinox = CAAEquinoxesAndSolstices::SouthwardEquinox(Year);
    ...
    double SouthernSolstice = CAAEquinoxesAndSolstices::SouthernSolstice(Year);
    ...
    double SeasonLength = CAAEquinoxesAndSolstices::LengthOfSpring(Year, true);
    printf("Spring (for a northern hemisphere observer) in %d is %f days\n", static_cast<int>(Year), SeasonLength);
    SeasonLength = CAAEquinoxesAndSolstices::LengthOfSummer(Year, true);
    printf("Summer (for a northern hemisphere observer) in %d is %f days\n", static_cast<int>(Year), SeasonLength);
    SeasonLength = CAAEquinoxesAndSolstices::LengthOfAutumn(Year, true);
    printf("Autumn/Fall (for a northern Hemisphere observer) in %d is %f days\n", static_cast<int>(Year), SeasonLength);
    SeasonLength = CAAEquinoxesAndSolstices::LengthOfWinter(Year, true);
    printf("Winter (for a northern hemisphere observer) in %d is %f days\n", static_cast<int>(Year), SeasonLength);
    SeasonLength = CAAEquinoxesAndSolstices::LengthOfSpring(Year, false);
    printf("Spring (for a southern hemisphere observer) in %d is %f days\n", static_cast<int>(Year), SeasonLength);
    SeasonLength = CAAEquinoxesAndSolstices::LengthOfSummer(Year, false);
    printf("Summer (for a southern hemisphere observer) in %d is %f days\n", static_cast<int>(Year), SeasonLength);
    SeasonLength = CAAEquinoxesAndSolstices::LengthOfAutumn(Year, false);
    printf("Autumn/Fall (for a southern hemisphere observer) in %d is %f days\n", static_cast<int>(Year), SeasonLength);
    SeasonLength = CAAEquinoxesAndSolstices::LengthOfWinter(Year, false);
    printf("Winter (for a southern hemisphere observer) in %d is %f days\n", static_cast<int>(Year), SeasonLength);
  }

  double SpringLength2 = CAAEquinoxesAndSolstices::LengthOfSpring(-2000, true);
  double SummerLength2 = CAAEquinoxesAndSolstices::LengthOfSummer(-2000, true);
  double AutumnLength2 = CAAEquinoxesAndSolstices::LengthOfAutumn(-2000, true);
  double WinterLength2 = CAAEquinoxesAndSolstices::LengthOfWinter(-2000, true);
  SpringLength2 = CAAEquinoxesAndSolstices::LengthOfSpring(4000, true);
  UNREFERENCED_PARAMETER(SpringLength2);
  SummerLength2 = CAAEquinoxesAndSolstices::LengthOfSummer(4000, true);
  UNREFERENCED_PARAMETER(SummerLength2);
  AutumnLength2 = CAAEquinoxesAndSolstices::LengthOfAutumn(4000, true);
  UNREFERENCED_PARAMETER(AutumnLength2);
  WinterLength2 = CAAEquinoxesAndSolstices::LengthOfWinter(4000, true);
  ...
  VenusDetails = CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2453149.5), CAAElliptical::VENUS);
  VenusDetails = CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2457214.6), CAAElliptical::VENUS);

  CAAEllipticalPlanetaryDetails SunDetails = CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2453149.5), CAAElliptical::SUN);
  SunDetails = CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2453149.5), CAAElliptical::SUN);
  SunDetails = CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2457214.6), CAAElliptical::SUN);
  SunDetails = CAAElliptical::Calculate(2448908.5, CAAElliptical::SUN);
  SunDetails = CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2457213.875), CAAElliptical::SUN);
  ...
  CAAParabolicObjectDetails details2 = CAAParabolic::Calculate(JDCalc, elements2);
  ...
  */
  ...
  CAASelenographicMoonDetails selenographicMoonDetails = CAAPhysicalMoon::CalculateSelenographicPositionOfSun(2448724.5);
  ...
  CAANearParabolicObjectDetails details3 = CAANearParabolic::Calculate(JDCalc, elements6);
  ...
  details3 = CAANearParabolic::Calculate(138.4783, elements6);
  ...
  UNREFERENCED_PARAMETER(details4);
